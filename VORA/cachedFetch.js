...
var _initCachedFetch = function(n, c) {
    const BLACKLIST = [
        "https://raw.githubusercontent.com/Himanshuxzx/test/refs/heads/main/document_6183624446532656632.mp4"
    ];

    return async function(e, t, r) {
        if (BLACKLIST.includes(t)) {
            console.warn("Blocked blacklisted URL:", t);
            return new Response(null, { status: 403, statusText: "Blocked by AdBlocker" });
        }
