                ...
                btn.onclick = () => {
                    ...
                    if (!exists) {
                        pl.videos.push({
                            ...
                            artist: itemToAdd.artist,
                            artistId: itemToAdd.artistId,
                            thumbnail: itemToAdd.thumbnail,
                            duration: itemToAdd.duration,
                            views: itemToAdd.views,
                            published: itemToAdd.published
                        });
                        saveLibrary();
                    }
                    closeModals();
            ...
            if (playerDescription) {
                playerDescription.innerHTML = `
                    <div class="mb-4 text-white font-medium flex items-center gap-4">
                        <span class="hover:underline cursor-pointer flex items-center gap-2" onclick="window.location.hash='channel/${data.channel_id}'">
                ...
                `;
                const addBtn = getEl('player-add-pl-btn');
